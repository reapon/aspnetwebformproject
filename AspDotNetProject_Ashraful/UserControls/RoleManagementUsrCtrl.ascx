<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RoleManagementUsrCtrl.ascx.cs" Inherits="AspDotNetProject_Ashraful.UserControls.RoleManagementUsrCtrl" %>
<br /> <br />
     <h2 style="text-align:center;">Manage User And Roles</h2>
    ...
    <div class="row">
        <div class="col-sm-12 table-responsive">
            ...
            <asp:GridView  ID="grdUsers" runat="server" DataKeyNames="Id"
                ...
                ItemType="AspDotNetProject_Ashraful.Models.ApplicationUser" 
